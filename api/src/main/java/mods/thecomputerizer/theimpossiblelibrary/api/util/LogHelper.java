...
public class LogHelper {
    ...
    public static void logInternal(Level level, String message, Object ... parameters) {
        ReferenceAPI.logLevel(level, message, parameters);
    }
    ...
    public static void logInternalCollection(Level level, String startingMessage, Collection<Object> collection,
        ...
        ReferenceAPI.logLevel(level, collectionToString(startingMessage, collection, toMessage, objectsPerLine));
    }
    ...
    public static class ModLogger {
        ...
        private ModLogger(String modid) {
            try {
                File logFile = FileHelper.generateNestedFile(injectParameters("./logs/mods/{}.log",modid),true);
