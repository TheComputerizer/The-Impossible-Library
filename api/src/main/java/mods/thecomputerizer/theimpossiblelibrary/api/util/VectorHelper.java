...
public class VectorHelper {
    ...
    public static final Vector2d MAX_2D = new Vector2d(Double.MAX_VALUE, Double.MAX_VALUE);
    ...
    public static final Vector3f MAX_3F = new Vector3f(Float.MAX_VALUE,Float.MAX_VALUE,Float.MAX_VALUE);
    public static final Vector3i MAX_3I = new Vector3i(Integer.MAX_VALUE,Integer.MAX_VALUE,Integer.MAX_VALUE);
    public static final Vector2d MIN_2D = new Vector2d(Double.MIN_VALUE,Double.MIN_VALUE);
    ...
    public static final Vector3f MIN_3F = new Vector3f(Float.MIN_VALUE,Float.MIN_VALUE,Float.MIN_VALUE);
    public static final Vector3i MIN_3I = new Vector3i(Integer.MIN_VALUE,Integer.MIN_VALUE,Integer.MIN_VALUE);
    public static final Vector2d ZERO_2D = new Vector2d(0d,0d);
    public static final Vector2f ZERO_2F = new Vector2f(0f,0f);
    public static final Vector2i ZERO_2I = new Vector2i(0,0);
    public static final Vector3d ZERO_3D = new Vector3d(0d,0d,0d);
    public static final Vector3f ZERO_3F = new Vector3f(0f,0f,0f);
