...
public abstract class LivingDeathEventWrapper<L> extends CancellableEvent implements LivingEventAPI {

    private final LivingEntityAPI<L> living;
    @Getter private final DamageAPI damage;

    protected LivingDeathEventWrapper(LivingEntityAPI<L> living, DamageAPI damage) {
        this.living = living;
        this.damage = damage;
    }
