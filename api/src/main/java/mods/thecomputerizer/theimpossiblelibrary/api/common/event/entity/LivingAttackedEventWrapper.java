...
public abstract class LivingAttackedEventWrapper<L> extends CancellableEvent implements LivingEventAPI {

    private final LivingEntityAPI<L> living;
    @Getter private final DamageAPI damage;

    protected LivingAttackedEventWrapper(LivingEntityAPI<L> living, DamageAPI damage) {
        this.living = living;
        this.damage = damage;
    }
