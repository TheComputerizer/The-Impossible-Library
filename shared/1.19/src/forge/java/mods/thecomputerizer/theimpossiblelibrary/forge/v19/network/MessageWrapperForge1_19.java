 ...
 */
public abstract class MessageWrapperForge1_19 extends MessageWrapperAPI<ServerPlayer,Context> {
    
    public static MessageWrapperForge1_19 getInstance(NetworkDirection dir) {
    ...
    public static MessageWrapperForge1_19 getInstance(NetworkDirection dir, ByteBuf buf) {
        boolean client = dir==LOGIN_TO_CLIENT || dir==PLAY_TO_CLIENT;
        boolean login = dir==LOGIN_TO_CLIENT || dir==LOGIN_TO_SERVER;
    ...
    public static Class<? extends MessageWrapperForge1_19> getClass(NetworkDirection dir) {
        boolean client = dir==LOGIN_TO_CLIENT || dir==PLAY_TO_CLIENT;
        boolean login = dir==LOGIN_TO_CLIENT || dir==LOGIN_TO_SERVER;
    ...
    MessageWrapperForge1_19(ByteBuf buf) {
        super(buf);
    }
