package mods.thecomputerizer.theimpossiblelibrary.shared.v19.client.sound;
...
public class Sound1_19 extends SoundAPI<SoundInstance> {
    
    public Sound1_19(Object sound) {
        super(sound);
    }
