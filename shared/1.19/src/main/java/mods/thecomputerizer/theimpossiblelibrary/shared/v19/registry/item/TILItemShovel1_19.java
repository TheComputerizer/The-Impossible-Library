...
public class TILItemShovel1_19 extends ShovelItem implements WithItemProperties {
    ...
    public TILItemShovel1_19(Tier tier, float damage, float speed, ItemProperties properties) {
