...
public class CompoundTag1_19 extends CompoundTagAPI<CompoundTag> {
    ...
    public CompoundTag1_19(CompoundTag tag) {
        super(tag);
    }
    ...
    @Override public CompoundTag1_19 getCompoundTag(String key) {
        return new CompoundTag1_19(this.wrapped.getCompound(key));
    }

    @Override public ListTag1_19 getListTag(String key) {
        return (ListTag1_19)getTag(key).asListTag();
    }

    @Override public PrimitiveTag1_19 getPrimitiveTag(String key) {
        return (PrimitiveTag1_19)getTag(key).asPrimitiveTag();
    }
