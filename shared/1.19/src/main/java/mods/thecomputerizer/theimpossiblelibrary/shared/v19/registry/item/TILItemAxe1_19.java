...
public class TILItemAxe1_19 extends AxeItem implements WithItemProperties {
    
    protected final ItemProperties properties;
    
    public TILItemAxe1_19(Tier tier, float damage, float speed, ItemProperties properties) {
