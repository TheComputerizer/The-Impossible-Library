package mods.thecomputerizer.theimpossiblelibrary.shared.v19.client.entity;
...
public class ClientPlayer1_19 extends Player1_19<LocalPlayer> {
    
    public ClientPlayer1_19(Object player) {
        super(player);
    }
