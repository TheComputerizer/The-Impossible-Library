...
public class TILDiscItem1_19 extends RecordItem implements WithItemProperties {
    ...
    public TILDiscItem1_19(SoundEvent sound, ItemProperties properties, int length) {
        super(0,sound,tab(new Properties().stacksTo(properties.getStackSize()),properties),length);
