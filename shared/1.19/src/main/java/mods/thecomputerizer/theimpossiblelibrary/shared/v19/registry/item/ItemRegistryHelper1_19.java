...
public abstract class ItemRegistryHelper1_19 extends ItemRegistryHelperAPI {

    private static final String POST = "v19.registry.item.ItemRegistryHelper";
    private static ItemRegistryHelper1_19 INSTANCE;
