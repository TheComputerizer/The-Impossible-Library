...
public class TILItemHoe1_19 extends HoeItem implements ItemHelpers1_19 {
    ...
    @IndirectCallers
    public TILItemHoe1_19(Tier tier, int damage, float speed, ItemProperties properties) {
