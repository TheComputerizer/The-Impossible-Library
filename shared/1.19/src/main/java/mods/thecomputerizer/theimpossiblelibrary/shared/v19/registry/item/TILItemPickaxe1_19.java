...
public class TILItemPickaxe1_19 extends PickaxeItem implements WithItemProperties {
    ...
    public TILItemPickaxe1_19(Tier tier, int damage, float speed, ItemProperties properties) {
