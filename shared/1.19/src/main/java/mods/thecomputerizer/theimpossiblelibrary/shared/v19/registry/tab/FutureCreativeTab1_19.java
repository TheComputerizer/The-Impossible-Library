...
public class FutureCreativeTab1_19 extends CreativeTabAPI<FutureCreativeTab<CreativeModeTab>> {
    ...
    public FutureCreativeTab1_19(FutureCreativeTab<CreativeModeTab> wrapped) {
        super(wrapped);
    }
    ...
    public void register(@Nullable Object event) {
        if(this.wrapped.isRegistered()) TILRef.logWarn("Tried to register FutureCreativeTab1_19 twice!");
