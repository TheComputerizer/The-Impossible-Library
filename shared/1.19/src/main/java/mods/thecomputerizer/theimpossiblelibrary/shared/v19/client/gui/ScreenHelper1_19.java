package mods.thecomputerizer.theimpossiblelibrary.shared.v19.client.gui;
...
public class ScreenHelper1_19 implements ScreenHelperAPI {
    ...
    @Override public void open(@Nullable ScreenAPI screen) {
        ...
        else mc.setScreen(new ScreenWrapper1_19(screen));
    }
