package mods.thecomputerizer.theimpossiblelibrary.fabric.v19.common.event;
...
import mods.thecomputerizer.theimpossiblelibrary.fabric.v19.common.event.events.*;
...
public abstract class CommonEventsFabric1_19 extends CommonEvents1_19 {
    ...
    @Override public void defineEvents() {
        ...
        LIVING_ATTACKED.setConnector(new LivingAttackedEventFabric1_19());
        LIVING_DAMAGE.setConnector(new LivingDamageEventFabric1_19());
        LIVING_DEATH.setConnector(new LivingDeathEventFabric1_19());
        LIVING_FALL.setConnector(new LivingFallEventFabric());
        LIVING_HEAL.setConnector(new LivingHealEventFabric());
        LIVING_HURT.setConnector(new LivingHurtEventFabric1_19());
        LIVING_JUMP.setConnector(new LivingJumpEventFabric());
        LIVING_KNOCKBACK.setConnector(new LivingKnockbackEventFabric());
        LIVING_LOOTING_LEVEL.setConnector(new LootingLevelEventFabric1_19());
    ...
    protected abstract void defineRegistryEvents(); //TODO Figure this out
