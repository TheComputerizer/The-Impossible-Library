...
public class RegistryForge1_19_4<V> extends Registry1_19_4<V> {
    
    public RegistryForge1_19_4(IForgeRegistry<V> forgeRegistry, ResourceLocationAPI<?> registryKey, Class<?> type) {
