...
public abstract class MessageWrapperFabric1_19_4<CTX> extends MessageWrapperAPI<ServerPlayer,CTX> implements FabricPacket {
    
    protected static final String TYPE_BASE = "message_wrapper_fabric";
    
    public static <M extends MessageWrapperFabric1_19_4<?>> M getPayloadInstance(Object dir) {
    ...
    protected MessageWrapperFabric1_19_4() {
        super();
    }
    
    protected MessageWrapperFabric1_19_4(ByteBuf buf) {
        super(buf);
    }
    ...
    public static final class Client<CTX> extends MessageWrapperFabric1_19_4<CTX> {
        
        @IndirectCallers public static PacketFlow FLOW = CLIENTBOUND;
        public static PacketType<MessageWrapperFabric1_19_4.Client<?>> TYPE = PacketType.create(
                TILRef.res(TYPE_BASE+"_client").unwrap(),MessageWrapperFabric1_19_4.Client::new);
        ...
        @Override public @NotNull PacketType<MessageWrapperFabric1_19_4.Client<?>> getType() {
            return TYPE;
        }
    }
    
    public static final class Server<CTX> extends MessageWrapperFabric1_19_4<CTX> {
        
        @IndirectCallers public static PacketFlow FLOW = SERVERBOUND;
        public static PacketType<MessageWrapperFabric1_19_4.Server<?>> TYPE = PacketType.create(
                TILRef.res(TYPE_BASE+"_server").unwrap(),MessageWrapperFabric1_19_4.Server::new);
        ...
        @Override public @NotNull PacketType<MessageWrapperFabric1_19_4.Server<?>> getType() {
            return TYPE;
        }
