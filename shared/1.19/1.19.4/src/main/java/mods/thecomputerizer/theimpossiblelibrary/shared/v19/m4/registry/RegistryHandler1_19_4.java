...
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.block.BlockBuilder1_19;
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.entity.EntityBuilder1_19;
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.item.DiscBuilder1_19;
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.item.ItemBlockBuilder1_19;
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.item.ItemBuilder1_19;
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.item.ToolBuilder1_19;
import mods.thecomputerizer.theimpossiblelibrary.shared.v19.registry.sound.SoundBuilder1_19;
...
public abstract class RegistryHandler1_19_4 implements RegistryHandlerAPI {

    private final Set<? super Registry1_19_4<?>> registries;
    protected Registry1_19_4<?> biome;
    protected Registry1_19_4<?> block;
    protected Registry1_19_4<?> blockEntity;
    protected Registry1_19_4<?> effect;
    protected Registry1_19_4<?> entity;
    protected Registry1_19_4<?> item;
    protected Registry1_19_4<?> potion;
    protected Registry1_19_4<?> sound;
    protected Registry1_19_4<?> structure;

    public RegistryHandler1_19_4() {
        Set<? super Registry1_19_4<?>> registries = new HashSet<>();
        collectRegistries(registries);
        this.registries = Collections.unmodifiableSet(registries);
    }
    
    protected abstract void collectRegistries(Set<? super Registry1_19_4<?>> registries);
    ...
    @Override public BlockBuilderAPI makeBlockBuilder(@Nullable BlockBuilderAPI parent) {
        return new BlockBuilder1_19(parent);
    }
