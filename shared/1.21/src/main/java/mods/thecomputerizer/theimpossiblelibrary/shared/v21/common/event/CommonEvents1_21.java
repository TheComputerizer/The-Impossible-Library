package mods.thecomputerizer.theimpossiblelibrary.shared.v21.common.event;
...
public abstract class CommonEvents1_21 implements CommonEventsAPI {
    
    private boolean defined;
    
    protected CommonEvents1_21() {
        this.defined = false;
    }
    ...
    @Override public <A> ActionResult getActionResult(A result) {
        return switch((InteractionResult)result) {
            ...
            case SUCCESS, SUCCESS_NO_ITEM_USED -> ActionResult.SUCCESS;
