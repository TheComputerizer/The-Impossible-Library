...
public class SpawnEntry1_21 extends SpawnEntryAPI<LivingEntity> { //TODO

    public SpawnEntry1_21(Class<? extends LivingEntity> clazz, int weight, int maxGroup, int minGroup) {
