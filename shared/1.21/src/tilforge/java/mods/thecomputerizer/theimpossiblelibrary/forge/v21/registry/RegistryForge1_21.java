...
public class RegistryForge1_21<V> extends Registry1_21<V> {
    
    public RegistryForge1_21(IForgeRegistry<V> forgeRegistry, ResourceLocationAPI<?> registryKey, Class<V> type) {
