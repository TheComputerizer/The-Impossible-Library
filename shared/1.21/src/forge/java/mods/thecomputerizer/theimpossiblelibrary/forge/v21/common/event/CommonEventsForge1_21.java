...
public class CommonEventsForge1_21 extends CommonEvents1_21 implements ForgeEventHelper {
    ...
    @Override public void defineEvents() {
        ...
        PLAYER_INTERACT_BLOCK.setConnector(new PlayerInteractBlockEventForge1_21());
        PLAYER_INTERACT_EMPTY.setConnector(new PlayerInteractEmptyEventForge1_21());
        PLAYER_INTERACT_ENTITY.setConnector(new PlayerInteractEntityEventForge1_21());
        PLAYER_INTERACT_ENTITY_AT.setConnector(new PlayerInteractEntitySpecificEventForge1_21());
        PLAYER_INTERACT_ITEM.setConnector(new PlayerInteractItemEventForge1_21());
        ...
        PLAYER_PUNCH_BLOCK.setConnector(new PlayerPunchBlockEventForge1_21());
