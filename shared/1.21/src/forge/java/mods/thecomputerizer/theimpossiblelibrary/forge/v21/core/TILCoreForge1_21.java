...
import mods.thecomputerizer.theimpossiblelibrary.forge.v21.core.loader.MultiVersionLoaderForge1_21;
...
public abstract class TILCoreForge1_21 extends TILCore1_21 implements TILCoreForge {
    ...
    private final MultiVersionLoaderForge1_21 loader;
    ...
    @Override public void addSources(Set<String> sources) {
        ...
        ClassHelper.addSource(sources,TILCoreForge1_21.class);
    }
    
    @Override public CommonEntryPoint getClientVersionHandler() {
        return TILClientEntryPointForge1_21.getInstance();
    }
    ...
    @Override protected ModWriter getModWriter(MultiVersionModInfo info) {
        return new ModWriterForge1_21(this,info);
    }
