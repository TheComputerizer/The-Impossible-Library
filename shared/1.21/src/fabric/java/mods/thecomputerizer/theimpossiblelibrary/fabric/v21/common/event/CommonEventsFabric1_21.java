package mods.thecomputerizer.theimpossiblelibrary.fabric.v21.common.event;
...
import mods.thecomputerizer.theimpossiblelibrary.fabric.v21.common.event.events.*;
...
public class CommonEventsFabric1_21 extends CommonEvents1_21 {
    ...
    @Override public void defineEvents() {
        ...
        LIVING_ATTACKED.setConnector(new LivingAttackedEventFabric1_21());
        LIVING_DAMAGE.setConnector(new LivingDamageEventFabric1_21());
        LIVING_DEATH.setConnector(new LivingDeathEventFabric1_21());
        LIVING_FALL.setConnector(new LivingFallEventFabric());
        LIVING_HEAL.setConnector(new LivingHealEventFabric());
        LIVING_HURT.setConnector(new LivingHurtEventFabric1_21());
        LIVING_JUMP.setConnector(new LivingJumpEventFabric());
        LIVING_KNOCKBACK.setConnector(new LivingKnockbackEventFabric());
        LIVING_LOOTING_LEVEL.setConnector(new LootingLevelEventFabric1_21());
        ...
        REGISTER_BLOCK_ENTITIES.setConnector(new RegisterBlockEntitiesEventFabric1_21());
        REGISTER_BLOCKS.setConnector(new RegisterBlocksEventFabric1_21());
        REGISTER_COMMANDS.setConnector(new RegisterCommandsEventFabric1_21());
        REGISTER_ENTITIES.setConnector(new RegisterEntitiesEventFabric1_21());
        REGISTER_ITEMS.setConnector(new RegisterItemsEventFabric1_21());
        REGISTER_SOUNDS.setConnector(new RegisterSoundEventsFabric1_21());
