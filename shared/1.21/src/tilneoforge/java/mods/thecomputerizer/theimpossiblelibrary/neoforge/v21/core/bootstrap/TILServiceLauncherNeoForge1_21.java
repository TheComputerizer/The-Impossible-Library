...
public class TILServiceLauncherNeoForge1_21 implements IModFileCandidateLocator {
    ...
    static final String CORE_PKG = "mods.thecomputerizer.theimpossiblelibrary.neoforge.v21.core";
    static final String LANGUAGE_LOADER = CORE_PKG+".MultiVersionLanguageLoader";
    static final String LOCATOR = CORE_PKG+".TILSelfLocator";
    static final String READER = CORE_PKG+".MultiVersionModReader";
    ...
    static {
        ...
        if(serviceLoaded) validateServices(c.getName(),LOCATOR,READER,LANGUAGE_LOADER);
    }
