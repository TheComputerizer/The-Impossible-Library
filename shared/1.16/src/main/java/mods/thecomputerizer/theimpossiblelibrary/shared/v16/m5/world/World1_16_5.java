...
public class World1_16_5 extends WorldAPI<IWorld> {
    ...
    @Override
    public Biome1_16_5 getBiomeAt(BlockPosAPI<?> pos) {
        return (Biome1_16_5)WrapperHelper.wrapBiome(this.world.getBiome(((BlockPos1_16_5)pos).getPos()));
    }

    @Override
    public Collection<BlockEntity1_16_5> getBlockEntitiesInBox(Box box) {
        List<BlockEntity1_16_5> entities = new ArrayList<>();
    ...
    @Override
    public @Nullable BlockEntity1_16_5 getBlockEntityAt(BlockPosAPI<?> pos) {
    ...
    @Override
    public List<Entity1_16_5> getEntitiesInBox(Box box) {
        return getEntitiesInBox(new AxisAlignedBB(box.min.x,box.min.y,box.min.z,box.max.x,box.max.y,box.max.z));
    }

    public List<Entity1_16_5> getEntitiesInBox(AxisAlignedBB box) {
        List<Entity1_16_5> entities = new ArrayList<>();
    ...
    @Override
    public List<Living1_16_5> getLivingInBox(Box box) {
        return getLivingInBox(new AxisAlignedBB(box.min.x,box.min.y,box.min.z,box.max.x,box.max.y,box.max.z));
    }

    public List<Living1_16_5> getLivingInBox(AxisAlignedBB box) {
        List<Living1_16_5> entities = new ArrayList<>();
    ...
    @Override
    public BlockState1_16_5 getStateAt(BlockPosAPI<?> pos) {
        return new BlockState1_16_5(this.world.getBlockState(((BlockPos1_16_5)pos).getPos()));
    }

    @Override
    public Structure1_16_5 getStructureAt(BlockPosAPI<?> api) {
