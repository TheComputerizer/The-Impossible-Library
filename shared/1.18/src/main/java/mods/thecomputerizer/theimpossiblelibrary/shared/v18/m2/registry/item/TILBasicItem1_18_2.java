...
public class TILBasicItem1_18_2 extends Item implements ItemHelpers1_18_2 {
    ...
    public TILBasicItem1_18_2(ItemProperties properties) {
        super(tab(new Properties().stacksTo(properties.getStackSize()),properties));
        this.properties = properties;
    }
    
    @Override public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> components,
            TooltipFlag flag) {
