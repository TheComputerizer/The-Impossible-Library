...
public class WorldTickEventNeoForge1_20_4 extends WorldTickEventNeoForge<LevelTickEvent> {
    ...
    @Override protected TickPhase wrapTickPhase() {
        return Objects.nonNull(this.event) ? (this.event.phase==Phase.START ? START : END) : DEFAULT;
    }
}