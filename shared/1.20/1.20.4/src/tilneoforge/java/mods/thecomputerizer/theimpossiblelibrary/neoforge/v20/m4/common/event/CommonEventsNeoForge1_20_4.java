...
public class CommonEventsNeoForge1_20_4 extends CommonEvents1_20 implements CommonEventsNeoForge1_20 {
    ...
    @Override public <E> E setEventResult(Result result) {
        return GenericUtils.cast(result==DEFAULT ? Event.Result.DEFAULT : (result==DENY ? Event.Result.DENY : Event.Result.ALLOW));
    }
}