...
import mods.thecomputerizer.theimpossiblelibrary.shared.v20.m6.registry.RegistryHandler1_20_6;
import mods.thecomputerizer.theimpossiblelibrary.shared.v20.m6.registry.RegistryVanilla1_20_6;
...
public class RegistryHandlerForge1_20_6 extends RegistryHandler1_20_6 {
    
    @Override protected void collectRegistries(Set<? super Registry1_20_6<?>> registries) {
    ...
    private <V> Registry1_20_6<V> getRegistry(Set<? super Registry1_20_6<?>> registries,
        ...
        Registry1_20_6<V> registry = new RegistryForge1_20_6<>(forgeRegistry,key,type);
        registries.add(registry);
        return registry;
    }
    
    @SuppressWarnings("SameParameterValue")
    private <V> Registry1_20_6<V> getVanillaRegistry(Set<? super Registry1_20_6<?>> registries,
            Registry<V> vanillaRegistry,String name, Class<?> type) {
        ResourceLocationAPI<?> key = WrapperHelper.wrapResourceLocation(new ResourceLocation(name));
        Registry1_20_6<V> registry = new RegistryVanilla1_20_6<>(vanillaRegistry, key, type);
        registries.add(registry);
        return registry;
    }
