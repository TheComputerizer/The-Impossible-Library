...
import static net.neoforged.neoforge.client.gui.VanillaGuiLayers.DEBUG_OVERLAY;

public class RenderOverlayTextEventNeoForge1_20_6 extends RenderOverlayTextEventWrapper<DebugText> {
    ...
    @Override protected EventFieldWrapper<DebugText,OverlayType> wrapOverlayType() {
        return wrapGenericGetter(event -> EventHelper.getOverlayElementType(DEBUG_OVERLAY),DEBUG);
    }
