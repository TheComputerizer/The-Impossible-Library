...
public abstract class MessageWrapperNeoForge1_20_6 extends MessageWrapperAPI<ServerPlayer,IPayloadContext> implements CustomPacketPayload {
    ...
    public static <M extends MessageWrapperNeoForge1_20_6> M getNeoInstance(Object dir) {
        return GenericUtils.cast(NetworkHelper.isDirToClient(dir) ? new Client() : new Server());
    }
    
    public static <M extends MessageWrapperNeoForge1_20_6> M getNeoInstance(ByteBuf buf, Object dir) {
    ...
    public static final class Client extends MessageWrapperNeoForge1_20_6 {
        ...
        static Type<MessageWrapperNeoForge1_20_6.Client> TYPE = new Type<>(TILRef.res(TYPE_BASE+"_client").unwrap());
    ...
    public static final class Server extends MessageWrapperNeoForge1_20_6 {
        ...
        static Type<MessageWrapperNeoForge1_20_6.Server> TYPE = new Type<>(TILRef.res(TYPE_BASE+"_server").unwrap());
