...
public class TextString1_20_6 extends Text1_20 implements TextStringAPI<Style> {
    
    private final TextHelper1_20 helper;
    private final MutableComponent component;
    private final String original;
    
    public TextString1_20_6(TextHelper1_20 helper, String original) {
        this.helper = helper;
    ...
    @Override public TextString1_20_6 setStyle(Style style) {
        this.component.setStyle(style);
        return this;
    }
    
    @Override public TextString1_20_6 withStyle(Style style) {
