...
public interface ItemBuilderHelpers1_20_6 {
    
    default ItemAPI<?> defaultBuild(ItemProperties properties) {
        return defaultBuild(properties,TILBasicItem1_20_6::new);
    }
    ...
    default void registerVariants(Item item) {
        if(CoreAPI.isClient()) ItemRegistryHelper1_20_6.registerItemModelVariants(item, getPropertyMapField());
    }
