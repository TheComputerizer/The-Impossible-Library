...
import mods.thecomputerizer.theimpossiblelibrary.shared.v20.m6.tag.ListTag1_20_6;
import mods.thecomputerizer.theimpossiblelibrary.shared.v20.m6.tag.PrimitiveTag1_20_6;
...
public class CompoundComponent1_20_6 extends CompoundTagAPI<CustomData> implements ComponentWrapper {
    ...
    public CompoundComponent1_20_6(CustomData data) {
        super(data);
    }
    ...
    @Override public PrimitiveTag1_20_6 getPrimitiveTag(String key) {
        return (PrimitiveTag1_20_6)getTag(key).asPrimitiveTag();
    }
