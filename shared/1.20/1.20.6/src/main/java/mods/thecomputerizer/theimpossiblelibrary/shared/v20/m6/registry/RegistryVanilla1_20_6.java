...
public class RegistryVanilla1_20_6<V> extends Registry1_20_6<V> {

    public RegistryVanilla1_20_6(Registry<V> registry, ResourceLocationAPI<?> registryKey, Class<?> type) {
