...
import mods.thecomputerizer.theimpossiblelibrary.shared.v20.registry.item.DiscBuilder1_20;
import mods.thecomputerizer.theimpossiblelibrary.shared.v20.registry.item.ItemBlockBuilder1_20;
...
public abstract class RegistryHandler1_20 implements RegistryHandlerAPI {

    private final Set<? super Registry1_20<?>> registries;
    protected Registry1_20<?> biome;
    protected Registry1_20<?> block;
    protected Registry1_20<?> blockEntity;
    protected Registry1_20<?> effect;
    protected Registry1_20<?> entity;
    protected Registry1_20<?> item;
    protected Registry1_20<?> potion;
    protected Registry1_20<?> sound;
    protected Registry1_20<?> structure;

    public RegistryHandler1_20() {
        Set<? super Registry1_20<?>> registries = new HashSet<>();
        collectRegistries(registries);
        this.registries = Collections.unmodifiableSet(registries);
    }
    
    protected abstract void collectRegistries(Set<? super Registry1_20<?>> registries);
    ...
    @Override public BlockBuilderAPI makeBlockBuilder(@Nullable BlockBuilderAPI parent) {
        return new BlockBuilder1_20(parent);
    }
    ...
    @Override public DiscBuilderAPI makeDiscBuilder(@Nullable ItemBuilderAPI parent) {
        return new DiscBuilder1_20(parent);
    }
    ...
    @Override public ToolBuilderAPI makeToolBuilder(@Nullable ItemBuilderAPI parent, ToolType tool) {
        return new ToolBuilder1_20(parent,tool);
    }
}