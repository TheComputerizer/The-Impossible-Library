...
public class Render1_20 extends RenderAPI {
    ...
    @Override public VertexWrapper getBufferBuilderPC(int mode, int vertices) {
        ...
        return new VertexWrapper1_20(getBufferMode(mode),POSITION_COLOR,vertices,3,4);
    }
    
    @Override public VertexWrapper getBufferBuilderPTC(int mode, int vertices) {
        RenderSystem.setShader(GameRenderer::getPositionTexColorShader);
        RenderSystem.setShaderColor(1f,1f,1f,1f);
        return new VertexWrapper1_20(getBufferMode(mode),POSITION_TEX_COLOR,vertices,3,2,4);
    }
