...
public class TILItemAxe1_20 extends AxeItem implements WithItemProperties {
    
    protected final ItemProperties properties;
    
    public TILItemAxe1_20(Tier tier, float damage, float speed, ItemProperties properties) {
