...
public class ItemBlockBuilder1_20 extends ItemBlockBuilderAPI {
    
    public ItemBlockBuilder1_20(@Nullable ItemBuilderAPI parent) {
        super(parent);
    }
    
    @Override public ItemAPI<?> build() {
        BlockItem item = new TILItemBlock1_20(this.block.get().unwrap(),buildProperties());
