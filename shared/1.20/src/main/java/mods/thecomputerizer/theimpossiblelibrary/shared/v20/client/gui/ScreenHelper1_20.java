package mods.thecomputerizer.theimpossiblelibrary.shared.v20.client.gui;
...
public class ScreenHelper1_20 implements ScreenHelperAPI {
    ...
    @Override public void open(@Nullable ScreenAPI screen) {
        ...
        else mc.setScreen(new ScreenWrapper1_20(screen));
    }
