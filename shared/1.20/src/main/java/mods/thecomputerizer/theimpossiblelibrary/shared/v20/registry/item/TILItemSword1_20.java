...
public class TILItemSword1_20 extends SwordItem implements WithItemProperties {
    
    protected final ItemProperties properties;
    
    public TILItemSword1_20(Tier tier, int damage, float speed, ItemProperties properties) {
