...
public class TILCustomTool1_20 extends TieredItem implements ItemHelpers1_20 {
    
    private final ItemProperties properties;
    
    @IndirectCallers @SuppressWarnings("unused") //TODO
    public TILCustomTool1_20(Tier tier, float damage, float speed, Set<Block> blocks, ItemProperties properties) {
