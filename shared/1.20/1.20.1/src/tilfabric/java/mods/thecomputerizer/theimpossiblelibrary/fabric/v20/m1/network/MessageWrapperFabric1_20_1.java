...
public abstract class MessageWrapperFabric1_20_1<CTX> extends MessageWrapperAPI<ServerPlayer,CTX> implements FabricPacket {
    
    protected static final String TYPE_BASE = "message_wrapper_fabric";
    
    public static <M extends MessageWrapperFabric1_20_1<?>> M getPayloadInstance(Object dir) {
    ...
    static <M extends MessageWrapperAPI<?,PacketSender>,P extends Player> TriConsumer<M,P,PacketSender> handler() {
        return (msg,player,sender) -> {
            if(msg.handle(sender) instanceof FabricPacket reply) sender.sendPacket(reply);
        };
    }
    ...
    protected MessageWrapperFabric1_20_1() {
        super();
    }
    
    protected MessageWrapperFabric1_20_1(ByteBuf buf) {
        super(buf);
    }
    ...
    public static final class Client<CTX> extends MessageWrapperFabric1_20_1<CTX> {
        
        @IndirectCallers public static PacketFlow FLOW = CLIENTBOUND;
        public static PacketType<MessageWrapperFabric1_20_1.Client<?>> TYPE = PacketType.create(
                TILRef.res(TYPE_BASE+"_client").unwrap(),MessageWrapperFabric1_20_1.Client::new);
        ...
        @Override public @NotNull PacketType<MessageWrapperFabric1_20_1.Client<?>> getType() {
            return TYPE;
        }
    }
    
    public static final class Server<CTX> extends MessageWrapperFabric1_20_1<CTX> {
        
        @IndirectCallers public static PacketFlow FLOW = SERVERBOUND;
        public static PacketType<MessageWrapperFabric1_20_1.Server<?>> TYPE = PacketType.create(
                TILRef.res(TYPE_BASE+"_server").unwrap(),MessageWrapperFabric1_20_1.Server::new);
        ...
        @Override public @NotNull PacketType<MessageWrapperFabric1_20_1.Server<?>> getType() {
            return TYPE;
        }
