package mods.thecomputerizer.theimpossiblelibrary.fabric.v20.m1.common.event.events;
...
public class RegisterCommandsEventFabric1_20_1 extends RegisterCommandsEventFabric {
    ...
    @Override public void registerCommand(CommandAPI command) {
        WrappedCommand1_20_1.register(this.event[0], command);
    }
}