...
This is the 1.18.2 Forge branch
...
```
The file ID for the latest version of `1.18.2-0.2.2` is `4424293`
...
dependencies {
  implementation fg.deobf('maven.modrinth:the-impossible-library:1.18.2-fileVersion')
}
```
