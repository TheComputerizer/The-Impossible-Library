...
public enum TomlPart {
    ...
    private final BiFunction<PacketBuffer, Table, AbstractType> packetReader;
    TomlPart(String id, Class<? extends AbstractType> classType, BiFunction<PacketBuffer, Table, AbstractType> packetReader) {
        this.id = id;
    ...
    public AbstractType decode(PacketBuffer buf, @Nullable Table parent) {
