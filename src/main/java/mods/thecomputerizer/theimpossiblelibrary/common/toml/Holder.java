...
public class Holder {
    ...
    public static Holder decoded(FriendlyByteBuf buf) {
    ...
    private Holder(FriendlyByteBuf buf) {
        this.backing = null;
    ...
    public <T> T getValOrDefault(String name, T defVal, boolean allowParsing, boolean allowToString,
        ...
        if(foundVar.isEmpty()) return defVal;
    ...
    public void encode(FriendlyByteBuf buf, boolean withBlanks, boolean withComments) {
