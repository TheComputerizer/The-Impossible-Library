...
public class GuiTestClasses {
    ...
    private static abstract class TestGui extends Screen {
        ...
        public void init() {
            super.init();
            this.center = new Vector2f(((float) this.width) / 2f, ((float) this.height) / 2f);
        }
    ...
    private static class TestOtherGui extends TestGui {
        ...
        public void init() {
            super.init();
            this.textBox = new TextFieldWidget(this.font,(this.width/4)*3,0,(this.width/4)-2,16,new StringTextComponent("test_gui_text"));
        ...
        private void drawScrollBar() {
            ...
            Vector2f end = new Vector2f(x, Math.min(this.height,top+perIndex));
