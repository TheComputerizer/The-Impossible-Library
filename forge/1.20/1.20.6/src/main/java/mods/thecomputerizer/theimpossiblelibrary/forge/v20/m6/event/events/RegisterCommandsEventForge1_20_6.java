package mods.thecomputerizer.theimpossiblelibrary.forge.v20.m6.event.events;
...
public class RegisterCommandsEventForge1_20_6 extends RegisterCommandsEventForge {
    ...
    @Override public void registerCommand(CommandAPI command) {
        WrappedCommand1_20_6.register(getEvent().getDispatcher(), command);
    }
}