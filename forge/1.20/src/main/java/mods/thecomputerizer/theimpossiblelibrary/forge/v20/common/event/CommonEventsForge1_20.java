...
public abstract class CommonEventsForge1_20 extends CommonEvents1_20 {
    ...
    @Override public void defineEvents() {
        ...
        PLAYER_INTERACT_BLOCK.setConnector(new PlayerInteractBlockEventForge1_20());
        PLAYER_INTERACT_EMPTY.setConnector(new PlayerInteractEmptyEventForge1_20());
        PLAYER_INTERACT_ENTITY.setConnector(new PlayerInteractEntityEventForge1_20());
        PLAYER_INTERACT_ENTITY_AT.setConnector(new PlayerInteractEntitySpecificEventForge1_20());
        PLAYER_INTERACT_ITEM.setConnector(new PlayerInteractItemEventForge1_20());
        ...
        PLAYER_PUNCH_BLOCK.setConnector(new PlayerPunchBlockEventForge1_20());
