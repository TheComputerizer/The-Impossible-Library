...
public class RegistryForge1_20<V> extends Registry1_20<V> {
    
    public RegistryForge1_20(IForgeRegistry<V> forgeRegistry, ResourceLocationAPI<?> registryKey, Class<V> type) {
