package mods.thecomputerizer.theimpossiblelibrary.forge.v20.core.loader;
...
public class TILModFileForge1_20 extends ModFile {
    ...
    public TILModFileForge1_20(SecureJar file, IModLocator locator, Collection<?> infos) {
        super(file,locator,mod -> getFileInfo(mod,infos),"MOD");
        this.infos = new HashMap<>();
        for(Object info : infos) this.infos.put((MultiVersionModInfo)info,null);
        TILRef.logInfo("Created TILModFileForge1_20 with {} in context {}",infos,Thread.currentThread().getContextClassLoader());
    }
