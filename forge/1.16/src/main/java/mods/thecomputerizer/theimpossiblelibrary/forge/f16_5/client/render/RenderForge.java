...
public class RenderForge implements RenderAPI {
    ...
    public VertexWrapper getBufferBuilderPC(int mode, int vertices) {
        return new VertexWrapperForge(mode,DefaultVertexFormats.POSITION_COLOR,vertices,3,4);
    }

    @SuppressWarnings("deprecation")
    @Override
    public VertexWrapper getBufferBuilderPTC(int mode, int vertices) {
        return new VertexWrapperForge(mode,DefaultVertexFormats.POSITION_TEX_COLOR,vertices,3,2,4);
    }
