...
public class TILDependencyConfig1_16_5 implements IConfigurable {
    
    private final Map<String,Object> infoMap;
    
    public TILDependencyConfig1_16_5(String modid, String version, String order, String side, boolean mandatory) {
