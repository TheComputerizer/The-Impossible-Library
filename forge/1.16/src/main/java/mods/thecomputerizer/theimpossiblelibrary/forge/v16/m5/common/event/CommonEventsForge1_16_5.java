...
public class CommonEventsForge1_16_5 extends CommonEvents1_16_5 implements ForgeEventHelper {
    ...
    @Override public void defineEvents() {
        ...
        PLAYER_INTERACT_BLOCK.setConnector(new PlayerInteractBlockEventForge1_16_5());
        PLAYER_INTERACT_EMPTY.setConnector(new PlayerInteractEmptyEventForge1_16_5());
        PLAYER_INTERACT_ENTITY.setConnector(new PlayerInteractEntityEventForge1_16_5());
        PLAYER_INTERACT_ENTITY_AT.setConnector(new PlayerInteractEntitySpecificEventForge1_16_5());
        PLAYER_INTERACT_ITEM.setConnector(new PlayerInteractItemEventForge1_16_5());
        ...
        PLAYER_PUNCH_BLOCK.setConnector(new PlayerPunchBlockEventForge1_16_5());
