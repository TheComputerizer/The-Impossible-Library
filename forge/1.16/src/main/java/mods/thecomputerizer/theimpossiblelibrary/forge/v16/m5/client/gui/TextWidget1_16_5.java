...
public class TextWidget1_16_5 extends TextWidgetAPI<TextFieldWidget> {

    public TextWidget1_16_5(TextFieldWidget text, WidgetShape shape) {
        super(text,shape);
    }
    ...
    public MinecraftAPI getMinecraft() {
        ...
        return Objects.nonNull(screen) ? screen.getMinecraft() : Minecraft1_16_5.getInstance();
    }
