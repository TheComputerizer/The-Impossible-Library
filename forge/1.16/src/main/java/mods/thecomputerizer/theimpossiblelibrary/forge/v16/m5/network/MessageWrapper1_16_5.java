 ...
 */
public abstract class MessageWrapper1_16_5 extends MessageWrapperAPI<ServerPlayerEntity,Context> {
    
    public static MessageWrapper1_16_5 getInstance(NetworkDirection dir) {
    ...
    public static MessageWrapper1_16_5 getInstance(NetworkDirection dir, ByteBuf buf) {
        boolean client = dir==LOGIN_TO_CLIENT || dir==PLAY_TO_CLIENT;
        boolean login = dir==LOGIN_TO_CLIENT || dir==LOGIN_TO_SERVER;
    ...
    public static Class<? extends MessageWrapper1_16_5> getClass(NetworkDirection dir) {
        boolean client = dir==LOGIN_TO_CLIENT || dir==PLAY_TO_CLIENT;
        boolean login = dir==LOGIN_TO_CLIENT || dir==LOGIN_TO_SERVER;
        return login ? (client ? ClientLogin.class : ServerLogin.class) : (client ? Client.class : Server.class);
    }
    
    MessageWrapper1_16_5() {
        super();
    }
    
    MessageWrapper1_16_5(ByteBuf buf) {
        super(buf);
    }
    
    public static final class Client extends MessageWrapper1_16_5 {
    ...
    public static final class ClientLogin extends MessageWrapper1_16_5 {
    ...
    public static final class Server extends MessageWrapper1_16_5 {
    ...
    public static final class ServerLogin extends MessageWrapper1_16_5 {
