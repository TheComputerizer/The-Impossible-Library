...
public class TILModFileForge1_19 extends ModFile {
    ...
    public TILModFileForge1_19(SecureJar file, IModLocator locator, Collection<?> infos) {
        ...
        TILRef.logInfo("Created TILModFileForge1_19 with {} in context {}",infos,Thread.currentThread().getContextClassLoader());
    }
    ...
    @Override public boolean identifyMods() {
        ...
        if(ret) {
            ...
            if(!coreMods.isEmpty() && !fixedCoreMods) {
                ...
                fixCoreModPackages("forge","forge.v19","forge.v19."+minor);
                fixedCoreMods = true;
            }
        }
        return ret;
