...
public abstract class CommonEventsForge1_19 extends CommonEvents1_19 implements ForgeEventHelper {
    ...
    @Override public void defineEvents() {
        ...
        PLAYER_INTERACT_BLOCK.setConnector(new PlayerInteractBlockEventForge1_19());
        PLAYER_INTERACT_EMPTY.setConnector(new PlayerInteractEmptyEventForge1_19());
        PLAYER_INTERACT_ENTITY.setConnector(new PlayerInteractEntityEventForge1_19());
        PLAYER_INTERACT_ENTITY_AT.setConnector(new PlayerInteractEntitySpecificEventForge1_19());
        PLAYER_INTERACT_ITEM.setConnector(new PlayerInteractItemEventForge1_19());
        ...
        PLAYER_PUNCH_BLOCK.setConnector(new PlayerPunchBlockEventForge1_19());
        ...
        REGISTER_BLOCK_ENTITIES.setConnector(new RegisterBlockEntitiesEventForge1_19()); //TODO Deferred registers?
