...
import mods.thecomputerizer.theimpossiblelibrary.forge.v19.core.loader.TILLanguageLoader1_19;
...
@IndirectCallers
public class TILLanguageProvider1_19_2 implements TILForgeLanguageProvider { //TODO This doesn't need to be version specific
    ...
    @Override public Consumer<ModFileScanData> getFileVisitor(CoreAPI core, IModLanguageProvider provider) {
        return scan -> {
            ...
            scan.addLanguageLoader(scan.getAnnotations().stream()
                        ...
                        .map(ad -> new TILLanguageLoader1_19(core,ad.clazz().getClassName(),(String)ad.annotationData().get("value"),scan))
                        .collect(Collectors.toMap(TILLanguageLoader1_19::getModid,Function.identity(),(a,b)->a)));
        };
    }
}
