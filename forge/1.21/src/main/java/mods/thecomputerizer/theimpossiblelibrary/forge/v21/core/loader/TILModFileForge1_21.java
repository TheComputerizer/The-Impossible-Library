...
public class TILModFileForge1_21 extends ModFile {
    ...
    public TILModFileForge1_21(SecureJar file, IModLocator locator, Collection<?> infos) {
    ...
    @Override public boolean identifyMods() {
        ...
        if(ret) {
            ...
            if(!coreMods.isEmpty() && !fixedCoreMods) {
                fixCoreModPackages("api","forge","forge.v21","forge.v21.m1");
                fixedCoreMods = true;
            }
        }
        return ret;
