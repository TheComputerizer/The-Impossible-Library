...
public class NetworkForge1_21 extends Network1_21<SimpleChannel,NetworkDirection<?>> {
    ...
    @SuppressWarnings("unchecked") @Override public void registerMessage(MessageDirectionInfo<NetworkDirection<?>> dir, int id) {
        Class<MessageWrapperForge1_21> msgClass = (Class<MessageWrapperForge1_21>)MessageWrapperForge1_21.getClass(dir.getDirection());
        getNetwork().messageBuilder(msgClass,id,dir.getDirection())
                .encoder(MessageWrapperForge1_21::encode)
                .decoder(buf -> MessageWrapperForge1_21.getInstance(dir.getDirection(), buf))
                .consumerNetworkThread(MessageWrapperForge1_21::handle)
                .add();
    }
    ...
    @Override public <CTX> MessageWrapperAPI<?,CTX> wrapMessage(NetworkDirection<?> dir, MessageAPI<CTX> message) {
        MessageWrapperAPI<?,CTX> wrapper = (MessageWrapperAPI<?,CTX>)MessageWrapperForge1_21.getInstance(dir);
