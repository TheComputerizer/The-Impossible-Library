...
public class ModFileInfoAccess extends AbstractModuleSystemAccessor {
    ...
    ModFileInfoAccess(Object modFileInfo, Object accessorOrLogger) {
        super(modFileInfo,accessorOrLogger);
    }
    
    public ModFileAccess file() {
        return NeoforgeModuleAccess.getModFile(invoke("getFile"),this);
    }
