package mods.thecomputerizer.theimpossiblelibrary.neoforge.v20.m6.core.loader;
...
public class TILModFileNeoForge1_20_6 extends ModFile {
    ...
    public TILModFileNeoForge1_20_6(SecureJar file, IModFileCandidateLocator locator, Collection<?> infos) {
    ...
    @Override public boolean identifyMods() {
        ...
        if(ret) {
            ...
            if(!coreMods.isEmpty() && !fixedCoreMods) {
                fixCoreModPackages("api","neoforge","neoforge.v20","neoforge.v20.m6");
                fixedCoreMods = true;
            }
        }
        return ret;
