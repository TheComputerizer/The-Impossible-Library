...
@IndirectCallers
public class TILLanguageProvider1_20_6 implements TILNeoForgeLanguageProvider {
    ...
    @Override public Consumer<ModFileScanData> getFileVisitor(CoreAPI core, IModLanguageLoader provider) {
        return scan -> {
