...
import mods.thecomputerizer.theimpossiblelibrary.legacy.advancement.AdvancementLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.world.ExplosionLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.world.WorldLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.block.BlockLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.block.BlockSnapShotLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.block.BlockStateLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.blockentity.BlockEntityLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.entity.EntityLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.entity.LivingLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.entity.PlayerLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.item.ItemLegacy;
import mods.thecomputerizer.theimpossiblelibrary.legacy.item.ItemStackLegacy;
