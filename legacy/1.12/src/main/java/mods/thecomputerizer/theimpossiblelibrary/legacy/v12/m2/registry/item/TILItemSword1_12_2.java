...
public class TILItemSword1_12_2 extends ItemSword implements WithItemProperties {
    
    protected final ItemProperties properties;
    
    public TILItemSword1_12_2(ToolMaterial material, ItemProperties properties) {
        super(material);
