...
public class PlayerPushOutOfBlocksEventLegacy extends PlayerPushOutOfBlocksEventWrapper<PlayerSPPushOutOfBlocksEvent> {
    ...
    protected Box wrapEntityBB() {
        return Objects.nonNull(this.event) ? EventsLegacy.getBox(this.event.getEntityBoundingBox()) : Box.ZERO;
    }
