...
import mods.thecomputerizer.theimpossiblelibrary.forge.v16.m5.core.loader.TILDependencyConfigForge1_16_5;
...
public class TILFileConfigFabric1_16_5 implements IConfigurable {
    ...
    public TILFileConfigFabric1_16_5(Collection<MultiVersionModInfo> infos) {
        ...
        for(MultiVersionModInfo info : infos) {
            this.childConfigs.get("mods").add(new TILModConfigFabric1_16_5(info));
