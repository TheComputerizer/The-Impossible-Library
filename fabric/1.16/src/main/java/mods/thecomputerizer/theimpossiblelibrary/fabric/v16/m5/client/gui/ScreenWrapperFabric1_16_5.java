...
public class ScreenWrapperFabric1_16_5 extends Screen implements Wrapped<ScreenAPI> {
    
    private final ScreenAPI wrapped;
    private boolean isOpen;

    public ScreenWrapperFabric1_16_5(ScreenAPI wrapped) {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int mod) {
        if(Objects.nonNull(this.wrapped)) {
            ...
            if(Screen.isCopy(keyCode)) {
                ...
                if(Objects.nonNull(copied) && Objects.nonNull(this.minecraft)) {
                    this.minecraft.keyboardHandler.setClipboard(copied);
                    return true;
                }
            }
            if(Screen.isPaste(keyCode) && Objects.nonNull(this.minecraft)) {
