package mods.thecomputerizer.theimpossiblelibrary.fabric.v19.network;
...
public abstract class MessageWrapperFabric1_19 extends MessageWrapperAPI<ServerPlayer,PacketSender> {
    
    public static MessageWrapperFabric1_19 getInstance(Object dir) {
    ...
    public static MessageWrapperFabric1_19 getInstance(Object dir, ByteBuf buf) {
        boolean client = dir==ClientNetworkingImpl.PLAY || dir==ClientNetworkingImpl.LOGIN;
        boolean login = dir==ClientNetworkingImpl.LOGIN || dir==ServerNetworkingImpl.LOGIN;
    ...
    public static Class<? extends MessageWrapperFabric1_19> getClass(Object dir) {
        boolean client = dir==ClientNetworkingImpl.PLAY || dir==ClientNetworkingImpl.LOGIN;
        boolean login = dir==ClientNetworkingImpl.LOGIN || dir==ServerNetworkingImpl.LOGIN;
        return login ? (client ? ClientLogin.class : ServerLogin.class) : (client ? Client.class : Server.class);
    }
    
    MessageWrapperFabric1_19() {
        super();
    }
    
    MessageWrapperFabric1_19(ByteBuf buf) {
        super(buf);
    }
    
    public abstract ResourceLocation getRegistryName();
    
    public static final class Client extends MessageWrapperFabric1_19 {
    ...
    public static final class ClientLogin extends MessageWrapperFabric1_19 {
    ...
    public static final class Server extends MessageWrapperFabric1_19 {
    ...
    public static final class ServerLogin extends MessageWrapperFabric1_19 {
