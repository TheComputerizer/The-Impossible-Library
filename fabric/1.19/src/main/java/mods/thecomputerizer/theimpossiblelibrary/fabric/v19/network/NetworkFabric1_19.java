...
public class NetworkFabric1_19 extends Network1_19<Object,Object> {
    ...
    ResourceLocation getRegistryName(MessageWrapperAPI<?,?> message) {
        return ((MessageWrapperFabric1_19)message).getRegistryName();
    }
    ...
    void registerClientReceiver(MessageDirectionInfo<Object> info) {
        ...
        ResourceLocation registryName = MessageWrapperFabric1_19.getInstance(dir).getRegistryName();
        ClientPlayNetworking.registerGlobalReceiver(registryName,(mc,handler,buf,sender) -> {
            MessageWrapperFabric1_19 wrapper = MessageWrapperFabric1_19.getInstance(dir,buf);
            MessageWrapperFabric1_19 response = (MessageWrapperFabric1_19)wrapper.handle(sender);
    ...
    @Override public <CTX> MessageWrapperAPI<?,CTX> wrapMessage(Object dir, MessageAPI<CTX> message) {
        MessageWrapperAPI<?,CTX> wrapper = (MessageWrapperAPI<?,CTX>)MessageWrapperFabric1_19.getInstance(dir);
