...
public class NetworkFabric1_20_1 extends Network1_20<Object,Object> {
    ...
    ResourceLocation getRegistryName(MessageWrapperAPI<?,?> message) {
        return ((MessageWrapperFabric1_20_1)message).getRegistryName();
    }
    ...
    void registerClientReceiver(MessageDirectionInfo<Object> info) {
        ...
        ResourceLocation registryName = MessageWrapperFabric1_20_1.getInstance(dir).getRegistryName();
        ClientPlayNetworking.registerGlobalReceiver(registryName,(mc,handler,buf,sender) -> {
            MessageWrapperFabric1_20_1 wrapper = MessageWrapperFabric1_20_1.getInstance(dir,buf);
            MessageWrapperFabric1_20_1 response = (MessageWrapperFabric1_20_1)wrapper.handle(sender);
    ...
    @Override public <CTX> MessageWrapperAPI<?,CTX> wrapMessage(Object dir, MessageAPI<CTX> message) {
        MessageWrapperAPI<?,CTX> wrapper = (MessageWrapperAPI<?,CTX>)MessageWrapperFabric1_20_1.getInstance(dir);
