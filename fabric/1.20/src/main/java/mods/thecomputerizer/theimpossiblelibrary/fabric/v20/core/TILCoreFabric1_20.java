...
import mods.thecomputerizer.theimpossiblelibrary.fabric.v20.core.loader.MultiVersionLoaderFabric1_20;
...
public abstract class TILCoreFabric1_20 extends TILCore1_20 implements TILCoreFabric {
    ...
    @Override public void addSources(Set<String> sources) {
        ...
        ClassHelper.addSource(sources,TILCoreFabric1_20.class);
    }
    ...
    @Override public CommonEntryPoint getCommonVersionHandler() {
        return new TILCommonEntryPointFabric1_20();
    }
    
    @Override public CoreEntryPoint getCoreVersionHandler() {
        return new TILCoreEntryPointFabric1_20();
    }
    ...
    @Override protected ModWriter getModWriter(MultiVersionModInfo info) {
        return new ModWriterFabric1_20(this,info);
    }
