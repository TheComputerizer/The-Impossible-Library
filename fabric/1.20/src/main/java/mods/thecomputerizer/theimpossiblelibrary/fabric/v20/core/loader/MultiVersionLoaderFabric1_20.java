package mods.thecomputerizer.theimpossiblelibrary.fabric.v20.core.loader;
...
public class MultiVersionLoaderFabric1_20 extends MultiVersionLoaderFabric {
    
    public MultiVersionLoaderFabric1_20(CoreAPI parent) {
        super(parent);
    }
