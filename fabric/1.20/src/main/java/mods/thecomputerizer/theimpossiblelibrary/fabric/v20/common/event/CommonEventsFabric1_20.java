...
import mods.thecomputerizer.theimpossiblelibrary.fabric.v20.common.event.events.*;
...
public abstract class CommonEventsFabric1_20 extends CommonEvents1_20 {
    ...
    @Override public void defineEvents() {
        ...
        LIVING_ATTACKED.setConnector(new LivingAttackedEventFabric1_20());
        LIVING_DAMAGE.setConnector(new LivingDamageEventFabric1_20());
        LIVING_DEATH.setConnector(new LivingDeathEventFabric1_20());
        LIVING_FALL.setConnector(new LivingFallEventFabric());
        LIVING_HEAL.setConnector(new LivingHealEventFabric());
        LIVING_HURT.setConnector(new LivingHurtEventFabric1_20());
        LIVING_JUMP.setConnector(new LivingJumpEventFabric());
        LIVING_KNOCKBACK.setConnector(new LivingKnockbackEventFabric());
        LIVING_LOOTING_LEVEL.setConnector(new LootingLevelEventFabric1_20());
