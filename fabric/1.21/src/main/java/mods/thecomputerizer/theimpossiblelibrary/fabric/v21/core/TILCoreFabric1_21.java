...
import mods.thecomputerizer.theimpossiblelibrary.fabric.v21.common.TILCommonEntryPointFabric1_21;
import mods.thecomputerizer.theimpossiblelibrary.fabric.v21.core.asm.ModWriterFabric1_21;
import mods.thecomputerizer.theimpossiblelibrary.fabric.v21.core.loader.MultiVersionLoaderFabric1_21;
...
public abstract class TILCoreFabric1_21 extends TILCore1_21 implements TILCoreFabric {

    public static final Reference FABRIC_REF = TILRef.instance(() -> FabricLoader.getInstance().getEnvironmentType()==CLIENT,"");
    private final MultiVersionLoaderFabric1_21 loader;

    public TILCoreFabric1_21(GameVersion version) {
        super(version,FABRIC,FABRIC_REF.isClient());
        this.loader = new MultiVersionLoaderFabric1_21(this);
    }
    ...
    @Override public void addSources(Set<String> sources) {
        ...
        ClassHelper.addSource(sources,TILCoreFabric1_21.class);
    }
    ...
    @Override public CommonEntryPoint getCommonVersionHandler() {
        return TILCommonEntryPointFabric1_21.getInstance();
    }
    
    @Override public CoreEntryPoint getCoreVersionHandler() {
        return new TILCoreEntryPointFabric1_21();
    }
    ...
    @Override protected ModWriter getModWriter(MultiVersionModInfo info) {
        return new ModWriterFabric1_21(this,info);
    }
