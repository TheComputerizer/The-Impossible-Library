...
import mods.thecomputerizer.theimpossiblelibrary.fabric.v18.m2.common.event.events.*;
...
@SuppressWarnings("unused") public class CommonEventsFabric1_18_2 extends CommonEvents1_18_2 {
    ...
    @Override public void defineEvents() {
        ...
        LIVING_ATTACKED.setConnector(new LivingAttackedEventFabric1_18_2());
        LIVING_DAMAGE.setConnector(new LivingDamageEventFabric1_18_2());
        LIVING_DEATH.setConnector(new LivingDeathEventFabric1_18_2());
        LIVING_FALL.setConnector(new LivingFallEventFabric());
        LIVING_HEAL.setConnector(new LivingHealEventFabric());
        LIVING_HURT.setConnector(new LivingHurtEventFabric1_18_2());
        LIVING_JUMP.setConnector(new LivingJumpEventFabric());
        LIVING_KNOCKBACK.setConnector(new LivingKnockbackEventFabric());
        LIVING_LOOTING_LEVEL.setConnector(new LootingLevelEventFabric1_18_2());
        ...
        REGISTER_BLOCK_ENTITIES.setConnector(new RegisterBlockEntitiesEventFabric1_18_2());
        REGISTER_BLOCKS.setConnector(new RegisterBlocksEventFabric1_18_2());
        REGISTER_COMMANDS.setConnector(new RegisterCommandsEventFabric1_18_2());
        REGISTER_ENTITIES.setConnector(new RegisterEntitiesEventFabric1_18_2());
        REGISTER_ITEMS.setConnector(new RegisterItemsEventFabric1_18_2());
        REGISTER_SOUNDS.setConnector(new RegisterSoundsEventFabric1_18_2());
